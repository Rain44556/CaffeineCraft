            ...
            <Fade bottom delay={790}>
              <div className="unique-coffees">
                <div className="coffee">
                  <img
                    src="./images/cappccino-coffee.jpg"
              ...
              <div className="unique-coffees">
                <div className="coffee">
                  <img
                    src="./images/americano-hot-coffee.jpg"
              ...
              <div className="unique-coffees">
                <div className="coffee">
                  <img
                    src="./images/ristretto-coffee.jpeg"
                    alt="Ristretto coffee"
                  />
                </div>
                <h2>Ristretto</h2>
                <p>$90</p>
              ...
              <div className="unique-coffees">
                <div className="coffee">
                  <img src="./images/latte-coffee.jpg" alt="Latte coffee" />
                </div>
                <h2>Latte</h2>
                <p>$95</p>
              </div>
              ...
              <div className="unique-coffees">
                <div className="coffee">
                  <img src="./images/mocha-coffee.jpg" alt="Mocha coffee" />
                </div>
                <h2>Mocha</h2>
                <p>$55</p>
              </div>
