        ...
        <div className="items-container">
          ...
          <ul className="items-filter">
            <Fade Right delay={700}>
              <li
                className={`item items-line ${
                  filter === "main-menu" && "active-item"
                }`}
